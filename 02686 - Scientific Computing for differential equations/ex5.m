...
tic 
[X1,T1,function_calls1,hs1] = ODEsolver(@VanPol,[mu],h,t0,tend,x0, "RK4",options);
time1 = toc;
...
options = struct('step_control',false, 'initialStepSize', false);
tic
[X2,T2,function_calls2,hs2] = ODEsolver(@VanPol,[mu],h,t0,tend,x0, "RK4",options);
time2 = toc;
...
options = struct('step_control',false, 'initialStepSize', false);
tic
[X3,T3,function_calls3,hs3] = ODEsolver(@VanPol,[mu],h,t0,tend,x0, "RK4",options);
time3 = toc;
...
sgtitle('Classic Runge-Kutta with fixed step size, $\mu = 3$','Interpreter','latex','FontSize',20) 
...
Lgnd.Position(2) = -0.0;
legend("Classic Runge-Kutta","ode45","ode15s",'NumColumns',3,'FontSize',16,'Interpreter','latex');
...
sgtitle('Classic Runge-Kutta with fixed step size, $\mu = 20$','Interpreter','latex','FontSize',20) 
...
Lgnd.Position(1) = 0.449;
Lgnd.Position(2) = -0.0;
legend("RK4","ode45","ode15s",'NumColumns',3,'FontSize',16,'Interpreter','latex');
...
sgtitle('Classic Runge-Kutta with adaptive step size, $\mu = 3$','Interpreter','latex','FontSize',20) 
...
options = struct('step_control',true, 'initialStepSize',true,'control_type', "PID",'Rtol',Rtol,'Atol',Atol);
tic
[X1,T1,function_calls1,hs1,rs1] = ODEsolver(@VanPol,[mu],h,t0,tend,x0, "RK4", options);
time1 = toc;
...
options = struct('step_control',true, 'initialStepSize',true,'control_type', "PID",'Rtol',Rtol,'Atol',Atol);
tic
[X2,T2,function_calls2,hs2,rs2] = ODEsolver(@VanPol,[mu],h,t0,tend,x0, "RK4", options);
time2 = toc;
...
options = struct('step_control',true, 'initialStepSize',true,'control_type', "PID",'Rtol',Rtol,'Atol',Atol);
tic
[X3,T3,function_calls3,hs3,rs3] = ODEsolver(@VanPol,[mu],h,t0,tend,x0, "RK4", options);
time3 = toc;
...
sgtitle('Classic Runge-Kutta with adaptive step size, $\mu = 20$','Interpreter','latex','FontSize',20) 
