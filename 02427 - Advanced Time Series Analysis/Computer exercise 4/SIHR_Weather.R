...
SIHR_Weather <- function(data){
  ...
  model$setParameter(beta = c(init = -4.12165, lb= -10, ub=0))
  ...
  model$setParameter(p1 = c(init = 3, lb = -10, ub = 10))
  model$setParameter(p2 = c(init = 1, lb = -15, ub = 10))
  model$setParameter(p3 = c(init = 1, lb = -10, ub = 10))
