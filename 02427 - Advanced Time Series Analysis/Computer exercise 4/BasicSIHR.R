...
BasicSIHR <- function(data){
  ...
  model$addSystem(dI ~ ((exp(beta)/1E6)*S*I - I*exp(gammaI))*dt   + exp(p2)*dw2)
  ...
  model$setParameter(beta = c(init=-4, lb=-20,ub=5))
  
  ##----------------------------------------------------------------
  # Set the initial value for the optimization
  model$setParameter(hf = c(init = -5, lb = -40, ub = 0))
  model$setParameter(gammaI = c(init = -2.5, lb = -40, ub = 0))
  model$setParameter(gammaH = c(init = -5, lb = -40, ub = 0))
  
  model$setParameter(p1 = c(init = 3, lb = -10, ub = 5))
  model$setParameter(p2 = c(init = 1, lb = -15, ub = 3))
  model$setParameter(p3 = c(init = 1, lb = -10, ub = 2))
  model$setParameter(p4 = c(init = 1, lb = -10, ub = 3))
  
  model$setParameter(e1 = c(init = -1, lb = -30, ub = 3))
  model$setParameter(e2 = c(init = -1, lb = -30, ub = 3))
  model$setParameter(e3 = c(init = -1, lb = -30, ub = 3))
